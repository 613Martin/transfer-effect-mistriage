...
abstract: |
  ...
  *Background:* Trauma results in approximately four million deaths annually. Clinical
  prediction models are often used for triage in early trauma care. This study aimed to 
  assess how transfers of clinical prediction models for early trauma 
  care between different care contexts within a single health system affected mistriage rates.
  ...
  *Methods:* Patients aged 15 years or older, registered between 2011-2016 
  ...
  Model performance was evaluated in all data sets using mistriage rate, undertriage 
  ...
  *Results:* `r total.number.of.patients ` patients were included. Transferred model
  ...
  Transfer of the low-volume model to the high-volume sample resulted in a significant 
  mistriage rate increase of `r highest.comp.mistriage`.
  
  *Conclusions:* Models developed in samples with high numbers of patients generally performed best after 
  transfer, and the model developed in the low-volume sample performed significantly worse after transfer.
