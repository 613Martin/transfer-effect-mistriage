...
results in approximatly 458,5 million cases anually across the globe [@RN999], 
and an estimated 3,8 million deaths [@RN1; @RN21]. Each year 9% of the world’s 
deaths are because of trauma, with the leading causes being road traffic accidents, 
suicide and homicide. Predictions indicate the incidence of these causes are 
...
## Participants 
The eligibility criteria were patients aged 15 years or above registered in SweTrau 
...
split based on number of patients. Temporal split made using date of traumatic event.
...
Due to centralized trauma care, non-metropolitan centres generelly have fewer 
resources, and less experience reciving trauma patients. They may rely 
on clinical prediction models more heavily for accurate trauma triage, and an 
increased mistriage leads to further strain on already limited resources
due to increased overtriage. Increased undertriage could also possibly lead to
...
of injury, or newer predictors like shock index might increase model
...
the authors believe further studies are warranted due to the potential economic 
