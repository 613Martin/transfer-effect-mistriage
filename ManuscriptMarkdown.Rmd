...
abstract: |
  ...
  *Conclusions:* In all samples, model transfer was associated with some degree of uncertainty. 
  Models developed in samples with high numbers of patients performed best after transfer, and the
  model developed in the low-volume sample performed worst after transfer.
