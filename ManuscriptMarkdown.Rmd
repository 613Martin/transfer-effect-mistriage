...
mistriage rates. In many data sets, varying degrees of uncertainty were observed 
when comparing the transferred performance to the receiving sample validation performance.

The most notable effect on model performance following model transfer were observed
...
reduced mistriage, this was primarily due to reduced overtriage.
...
high-volume model to the low-volume sample reduces mistriage.

In a clinical context, this seems to suggest clinical prediction models for early 
trauma care should be developed in settings with a high number of trauma patients. 
These models could then be transferred to settings with less trauma patients. Low-volume 
centres generally have fewer resources and less experience receiving trauma patients, 
these centres could therefore benefit by using models developed in centres with more 
experience receiving trauma patients

Recognizing settings with high mistriage and updating models accordingly could lead
